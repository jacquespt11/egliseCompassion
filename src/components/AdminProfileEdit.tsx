// src/components/AdminProfileEdit.tsx
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-8 border-t border-white/10">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 text-white py-4 rounded-xl font-bold text-lg shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40 transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden"
              >
                {/* Animation d'ondulation au survol (alternative à framer-motion) */}
                ...
                <span className="flex items-center justify-center gap-3 relative z-10">
                  {isSubmitting ? (
                    ...
                    <>
                      ...
                      <span>Compléter le profil et accéder au tableau de bord</span>
                    </>
                  )}
                </span>
              </button>
